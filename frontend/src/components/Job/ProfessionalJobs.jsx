...
import { GetAllEmployerJobs, GetAllProfessionalJobs } from "../../service/jobService";
...
export default function ProfessionalJobs({ user }) {
  ...
  const fetchAllJobs = async () => {
    await GetAllProfessionalJobs(user._id)
      .then(({ data }) => {
        setRows(data);
        console.log(data);
      })
